\begin{table}[t]
\centering
\caption{Mean closure rate per cell $\times$ path with $n_{\text{valid}}$ in parentheses. Path 1: mutation kill rate; Path 2: reference-test pass rate; Path 3: BERTScore F1.}
