...
\needspace{0.85\textheight}
\begin{center}
  \includegraphics[width=0.85\linewidth,height=0.85\textheight,keepaspectratio]{../plots/output/fig2_closure_heatmap.png}
\end{center}
\vspace{-6pt}
\begin{quote}
...
\begin{center}
  \includegraphics[width=0.7\linewidth,height=0.85\textheight,keepaspectratio]{../plots/output/fig3_mono_vs_hetero.png}
\end{center}
\vspace{-6pt}
\begin{quote}
...
\needspace{0.45\textheight}
\begin{center}
  \includegraphics[width=0.9\linewidth,height=0.85\textheight,keepaspectratio]{../plots/output/fig10_stage_contribution.png}
\end{center}
\vspace{-6pt}
\begin{quote}
...
\begin{center}
  \includegraphics[width=0.95\linewidth,height=0.85\textheight,keepaspectratio]{../plots/output/fig7_judge_corr.png}
\end{center}
\vspace{-6pt}
\begin{quote}
...
\begin{itemize}
  ...
  \item \textbf{At most one cell (H9) is top-5 on all three paths, and only via a tie.} H9 is top-5 on Paths~2 and~3 outright but shares fifth place on Path~1 with M6 (both $V = 0.720$). No cell is unambiguously in the top-5 on all three paths.
  \item \textbf{Kendall's $\tau_{\textsf{rank}}$ between path rankings ranges $0.26$--$0.40$.} Path~1 vs.\ Path~2: $\tau = 0.265$; Path~1 vs.\ Path~3: $\tau = 0.404$; Path~2 vs.\ Path~3: $\tau = 0.301$. All three pairs show only weak-to-moderate ordinal agreement.
\end{itemize}

These four measures give the small variance-explained finding its operational meaning: no pair of path rankings exceeds moderate ordinal agreement ($\tau \leq 0.40$), and the winner set changes wholesale across paths. For a practitioner choosing an SLM composition, the pipeline stage that will dominate quality is not derivable from a single-path benchmark --- each path must be measured separately.
