...
\midrule
RQ1 & Hetero compositions \emph{match} the strongest mono baseline on aggregate metric mean, and \emph{exceed} it under decomposition & H6 $\bar{Y} = 0.882$ vs.\ M3 $0.900$ (Tukey n.s.); H1 leads 4 of 5 mutation operators (up to $\Delta = +0.133$); H4/H11 exceed the mono ceiling on $V$ ($0.909$/$0.859$ vs.\ $0.773$) & \S\ref{sec:discussion_rq1} \\
\addlinespace
...
\addlinespace
RQ4 & False-closure rates sit at or below the empirical noise floor for every cell except the one carrying the phi-4 pathology & Mean $7.7\%$; N1 noise floor $26.3\%$; only H10 above it ($28.6\%$, Path~1) & \S\ref{sec:discussion_rq4} \\
\midrule
