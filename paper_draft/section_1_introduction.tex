...
\subsection{Position in the thesis}
...
This chapter addresses four research questions. A fifth research question originally in the pre-registered concept note (RQ4: open-weight versus closed-weight ceiling comparison) was deferred to a follow-up study due to resource constraints during the sweep phase --- see Section~6 (Threats to Validity) for a detailed discussion of this deviation.
