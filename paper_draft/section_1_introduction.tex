...
\addlinespace
RQ4 & False-closure rates sit at or below the empirical noise floor for every cell except the one carrying the phi-4 pathology & Mean $7.7\%$; N1 noise floor $\bar{Y} = 0.429$; only H10 above the false-closure noise band ($28.6\%$, Path~1) & \S\ref{sec:discussion_rq4} \\
\midrule
