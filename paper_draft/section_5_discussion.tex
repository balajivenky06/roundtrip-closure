...
\textbf{Human evaluation.} The 60-pair stratified human evaluation described in Section~3.9 of the concept note is prepared but not yet completed. Its results (judge--human agreement via Cohen's $\kappa$ and Krippendorff's $\alpha$; per-cell judge-error rate) will be reported in an addendum to this chapter.
