...
\textbf{Mitigation.} The deviation is disclosed here, in Section~1.3 (research questions), and in the concept-note diff maintained in the replication package. The pre-registered closed-weight cells remain recorded in the DOE table with an explicit deferred marker. The remaining 20-cell open-weight sweep is complete.
