...
\textbf{Mitigation.} The five operators are the canonical set inherited from the second companion paper, which itself follows the standard mutation-testing literature~\citep{Andrews2005MutationAnalysis, Just2014MutationAnalysis}. The second companion paper discusses the operator-coverage limitation and its implications for the mutation kill rate metric.
