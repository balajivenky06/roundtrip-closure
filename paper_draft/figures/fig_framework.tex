...
\begin{figure*}[t]
  ...
  \begin{tikzpicture}[
    ...
    %% Judges → validity: three connectors landing on the top edge (not the
    %% side) of the validity box, so no line crosses the box text.
    %% P3J points straight down; P1J and P2J curve down-and-left to land at
    %% distinct points along the top-right region of the validity box.
    \draw[->, dashed, gray!70] (P1J.south)
      to[out=-90, in=60, looseness=0.9]
      ([xshift=-1.0cm]validity.north east);
    \draw[->, dashed, gray!70] (P2J.south)
      to[out=-90, in=50, looseness=0.7]
      ([xshift=-2.2cm]validity.north east);
