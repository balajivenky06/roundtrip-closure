...
\tnotemark[1]
\tnotetext[1]{Pre-registered replication package including the 20-cell DOE, the 5{,}890-row sweep TSV, closure-decision + test-filter algorithms with 67 unit tests, and all analysis scripts is publicly available at \url{https://github.com/balajivenky06/roundtrip-closure} under the MIT licence.}
...
behavioural-path closure rates hold or improve under function-rename +
docstring-paraphrase, ruling out surface-form memorisation. We derive
