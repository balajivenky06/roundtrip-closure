...
\usepackage{array}
\usepackage{multirow}
\usepackage{float}    % anchors figures at source, prevents cas-sc float clustering
\usepackage{capt-of}  % allows non-floating figure captions via \captionof
\usepackage{needspace} % forces page-break-before if figure won't fit
\usepackage{tikz}
...
empirically leads on four of five mutation operators (two operator wins
with tight Wilson 95\% CIs, two consistent-with-dominance at smaller
mutant counts). Second, phi-4
...
$76$--$91\%$ of the strongest mono baseline; poorly-composed cells
...
\item H1 (phi-4 spec + qwen-coder test/code) leads on 4 of 5 mutation operators (Wilson 95\% CIs)
...
\input{section_8_limitations.tex}
...
%% ============================================================================
%% ============================================================================
%% Appendix A — decision-policy ablation detail (moved from §5.9.3; the
%% summary with headline numbers remains in the Results section).
%% ============================================================================
\appendix
\input{section_appendix_strict_and.tex}
